/*
TypeScript port of Stefan Gustavson's implementation of Ken Perlin's simplex noise
...
class SimplexNoise {
    ...
    constructor(octaves: number, falloff: number) {
      this.F3 = 1 / 3;
      this.G3 = 1 / 6;
    ...
    generateNoise(x: number, y: number, z: number): number {
      let fResult = 0;
